...
public class MainResturantList extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeView.setColorSchemeColors(Color.YELLOW, Color.WHITE);
...
//							"city list refreshed", Toast.LENGTH_SHORT).show();
    ...
    private class RetrieveFeedTask extends AsyncTask<Void, Void, String> {
        ...
        protected String  doInBackground(Void... urls) {
            ...
            //  String API_URL = "http://globalfoodsystem.com/Api/RestaurantsDirectory/Restaurants/?restaurant=0&latitude=42.9797824&longitude=-81.2443568&limit="+ limit;
            String API_URL = "http://globalfoodsystem.com/Api/RestaurantsDirectory/Restaurants/?restaurant=5&latitude="+latitude+"&longitude="+longitude+"&limit="+ limit;
